...
reportHeader = config['tuning_analysis'][-1]['report'][-1]['header']
reportImage = config['tuning_analysis'][-1]['report'][-1]['image']
reportPCD = config['tuning_analysis'][-1]['report'][-1]['pcds']
reportChargeLoss = config['tuning_analysis'][-1]['report'][-1]['chargeloss']
reportCalibrationDarkcurrent = config['tuning_analysis'][-1]['report'][-1]['calibration_darkcurrent']
reportFFTskips = config['tuning_analysis'][-1]['report'][-1]['fft_skips']
reportFFTrow = config['tuning_analysis'][-1]['report'][-1]['fft_row']
